...
{
    public sealed class SceneFindOpenQuestionsAction : IAiAction
    {
        public const string ActionIdValue = "scene.find-open-questions";

        public string ActionId => ActionIdValue;

        public string DisplayName => "Find open questions";
        ...
        public AiRequest BuildRequest(AiActionInput input)
        {
            ...
            string instruction = string.IsNullOrWhiteSpace(input.Instruction)
                ? "Find unanswered questions or loose ends in this section."
