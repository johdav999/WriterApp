...
{
    public sealed class StoryboardCheckSubplotContinuityAction : IAiAction
    {
        public const string ActionIdValue = "storyboard.check-subplot-continuity";

        public string ActionId => ActionIdValue;

        public string DisplayName => "Check subplot continuity";
        ...
        public AiRequest BuildRequest(AiActionInput input)
        {
            ...
            {
                instruction = "Check subplot continuity across the storyboard.";
            }
