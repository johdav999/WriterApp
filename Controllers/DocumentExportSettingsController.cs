        ...
        private async Task<ExportPresetDto?> TryGetPresetAsync(string userId, Guid presetId, CancellationToken ct)
        {
            ...
            try
            {
                settings = JsonSerializer.Deserialize<ExportPresetSettingsDto>(preset.SettingsJson, JsonOptions)
                    ?? new ExportPresetSettingsDto("html", null, "document", false, 0, false, false, null, null, null, false, null, null, null, null, null, null);
            }
            catch
            {
                settings = new ExportPresetSettingsDto("html", null, "document", false, 0, false, false, null, null, null, false, null, null, null, null, null, null);
            }
