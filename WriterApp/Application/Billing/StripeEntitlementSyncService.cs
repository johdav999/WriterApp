    ...
    public sealed class StripeEntitlementSyncService
    {
            ...
            CancellationToken ct)
        {
            ...
            _logger.LogInformation(
                "Entitlement sync applied. UserId={UserId} PlanBefore={PlanBefore} PlanAfter={PlanAfter} StripeCustomerId={StripeCustomerId} StripeSubscriptionId={StripeSubscriptionId} StripePriceId={StripePriceId}",
                userId,
                planBefore,
